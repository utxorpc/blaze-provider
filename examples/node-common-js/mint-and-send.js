// Example: Mint native assets and send them in a single transaction (CommonJS)
const {
  Bip32PrivateKey,
  mnemonicToEntropy,
  NetworkId,
...
const { makeValue } = require("@blaze-cardano/tx");
const { U5C } = require("@utxorpc/blaze-provider");
...
async function main() {
  ...
  // Step #7: Create recipient address for sending some minted assets
  ...
  // Step #6: Build the transaction that mints and sends assets
  try {
